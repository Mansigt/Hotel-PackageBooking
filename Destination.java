...
public class Destination extends JFrame implements Runnable {
   ...
   // JLabel caption;
    public void run(){
      //  String[] text=new String[]{"JW Mariot Hotel","Madarin Oriental hotel","Four Seasons Hotel","Radison Hotel","Classio Hotel","Bay club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
